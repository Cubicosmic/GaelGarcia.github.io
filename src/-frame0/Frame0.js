...
export default function Frame0({ setPage }) {
    ...
    return (
        <motion.section 
            ...
            {/* navegador */}
            <motion.nav
                className='flex justify-between absolute text-xs sm:text-2xl z-40'
                        ...
                        <AnimatePresence>
                            {hoverAnimation === 1 && <motion.div
                                ...
                                style={{zIndex: -5}}>
                                    ...
                                    <div style={{width: "8em", height: "2em", borderRadius: "50%", background: "radial-gradient(circle, rgba(50,50,50,1), rgba(50,50,50,0.2))" }}></div>
